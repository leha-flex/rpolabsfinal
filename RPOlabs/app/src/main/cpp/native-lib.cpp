...
auto android_logger = spdlog::android_logger_mt( "android", "chel_ndk");
...
Java_com_pro_rpolabs_MainActivity_initRng(
        JNIEnv *env,
        jclass clazz ) {
...
Java_com_pro_rpolabs_MainActivity_randomBytes(
        JNIEnv *env,
        jclass clazz,
        jint n ) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_pro_rpolabs_MainActivity_encrypt(
        JNIEnv *env,
        jclass clazz,
        jbyteArray key,
        jbyteArray data ) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_pro_rpolabs_MainActivity_decrypt(
        JNIEnv *env,
        jclass clazz,
        jbyteArray key,
        jbyteArray data ) {
